          ...
          >
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className={`font-black text-2xl tracking-tight font-sans ${themeConfig.textPrimary}`}>
              ...
              <p className={`text-[11px] font-medium ${themeConfig.textSecondary} hidden sm:block`}>
                {t.appTagline}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border-2 border-brand-500/40 hover:border-brand-400 text-xs font-bold text-white transition-all shadow-md cursor-pointer"
                title={`${t.theme.label}: ${currentThemeObj.label}`}
              >
                <Palette className="w-4 h-4 text-brand-400 shrink-0" />
                <span className="hidden sm:inline text-xs font-semibold">{currentThemeObj.label}</span>
